...
//         return C;
//     }
//     Matrix matrixExponenciation(Matrix base, int exponent){
//         if(exponent == 0){
...
//             return I;
//         }
//         Matrix half = matrixExponenciation(base, exponent/2);
//         Matrix result = matrixMultiplication(half, half);

//         if(exponent%2 == 1){
//            result = matrixMultiplication(result, half);
//         }
//         return result;
//     }
// public:
...
//         Matrix result = matrixExponenciation(T, t);
